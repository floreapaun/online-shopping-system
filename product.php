				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" ><i class="fa fa-shopping-cart"></i> Adauga in cos</button>
                                </div>
					...
					<div class="col-md-12">
						<div id="product-tab">
							<!-- product tab nav -->
							<ul class="tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab1">Descriere</a></li>
							</ul>
							<!-- /product tab nav -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 class="title">Produse asemanatoare</h3>
